...
if strcmp(partToRun,'arms')
    ...
    left_arm_tzParams.val = {...
        [ -150      135     0     90  ],repmat(vel,[1 n_joints]),   true      ,true      ,true      ,true      ,true      ,true      ,true      ;...
        [ 20         20     0     19  ],repmat(vel,[1 n_joints]),   true      ,true      ,true      ,true      ,true      ,true      ,true      ;...
        [ -150      135    30     19  ],repmat(vel,[1 n_joints]),   true      ,true      ,true      ,true      ,true      ,true      ,true      ;...
        [ 20         20    30     90  ],repmat(vel,[1 n_joints]),   true      ,true      ,true      ,true      ,true      ,true      ,true      ;...
        [ -150      135    30     90  ],repmat(vel,[1 n_joints]),   true      ,true      ,true      ,true      ,true      ,true      ,true      ;...
        [ 20         20     0     90  ],repmat(vel,[1 n_joints]),   true      ,true      ,true      ,true      ,true      ,true      ,true      ;...
        [ -150      135    30     90  ],repmat(vel,[1 n_joints]),   true      ,true      ,true      ,true      ,true      ,true      ,true      };
